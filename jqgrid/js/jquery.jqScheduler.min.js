...
i=" ui-state-disabled");+g==+d&&g.getMonth()==e?c.addClass(E+"-state-highlight fc-today"):c.removeClass(E+"-state-highlight fc-today");var l=c.find("div.fc-day-number");l.text(g.getDate());var z=l.parent().parent();b||(l=z.attr("class").split(" "),a.each(l,function(a,b){-1!==b.indexOf("fc-day")&&z.removeClass(b)}));z.addClass(E+"-widget-content fc-day"+i);h(g,1)})});G.filter(".fc-year-have-event").removeClass("fc-year-have-event ui-state-default")}function f(a){if(n("selectable")){var b=this.className.search("fc-day-");
-1!=b&&(b=this.className.substring(b+7,b+7+10),b=b.split("-"),b=new Date(b[0],parseInt(b[1])-1,b[2],0,0,0),k("reportDayClick",this,b,!0,a))}}function g(a,b,d){d&&J.build();for(var d=o(p.visStart),c=h(o(d),L),e=0;e<S;e++){var l=new Date(Math.max(d,a)),z=new Date(Math.min(c,b));if(l<z){var m;V?(m=s(z,d)*I+M+1,l=s(l,d)*I+M+1):(m=s(l,d),l=s(z,d));i(e,m,e,l-1).click(f)}h(d,7);h(c,7)}}function i(a,d,c,e){a=J.rect(a,d,c,e,b);return v(a,b)}function l(a){return{row:Math.floor(s(a,p.visStart)/7),col:r(a.getDay())}}
function j(a){return h(o(p.visStart),7*a.row+a.col*I+M)}function r(a){return(a-Math.max(U,N)+L)%L*I+M}var p=this;p.renderYear=function(d,c,g,i){S=c;L=g;(V=n("isRTL"))?(I=-1,M=L-1):(I=1,M=0);U=n("firstDay");N=n("weekends")?0:1;E=n("theme")?"ui":"fc";n("columnFormat");if(d=!q){for(var g=E+"-widget-header",l=E+"-widget-content",z,m,j,r=o(p.start),ea=ca.dayNamesShortest,Da=ca.monthNames,c="<table class='fc-border-separate fc-year-main-table' style='width:100%'><tr >",k=0;12>k;k++){r.setFullYear(r.getFullYear(),
k,1);r.setFullYear(r.getFullYear(),k,1-r.getDay());0==k%3&&0<k&&(c+="</tr><tr>");c+="<td class='fc-year-monthly-td ui-widget'>";c+="<table class='ui-widget' style='width:100%' cellspacing='0'><thead><tr><th colspan='7' class='fc-year-monthly-header "+g+"' style='height:18px'>"+Da[k]+"</th></tr><tr>";for(z=0;z<L;z++)c+="<th class='fc-year-month-weekly-head'>"+ea[z]+"</th>";c+="</tr></thead><tbody>";for(z=0;6>z;z++){c+="<tr class='ui-widget-content fc-week"+z+"'>";for(m=0;m<L;m++)j=r.getMonth()==k?
F(r,"-yyyy-MM-dd"):"",c+="<td style='height:32px' class='fc- "+l+" fc-day"+j+"'><div>"+(i?"<div class='fc-day-number'/>":"")+"<div class='fc-day-content'></div></div></td>",h(r,1);c+="</tr>"}c+="</tbody></table>";c+="</td>"}q=a(c+"</tr></table>").appendTo(b);w=q.find("thead");u=w.find("th");T=q.find("table");G=q.find("table tr td");G.click(f);t=a("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(b)}else x();e(d)};p.setHeight=function(a){Z=a;a=Z-w.height();q.parent().height(a).css("overflow-y",
"auto")};p.setWidth=function(){};p.renderDayOverlay=g;p.defaultSelectionEnd=function(a){return o(a)};p.renderSelection=function(a,b){g(a,h(o(b),1),!0)};p.clearSelection=function(){C()};p.reportDayClick=function(a,b,d){var c=l(a);k("dayClick",A[c.row*L+c.col],a,b,d)};p.dragStart=function(a,b){y.start(function(a){C();a&&i(a.row,a.col,a.row,a.col)},b)};p.dragStop=function(a,b,d){var c=y.stop();C();c&&(c=j(c),k("drop",a,c,!0,b,d))};p.defaultEventEnd=function(a){return o(a.start)};p.getHoverListener=function(){return y};
p.colContentLeft=function(a){return K.left(a)};p.colContentRight=function(a){return K.right(a)};p.dayOfWeekCol=r;p.dateCell=l;p.cellDate=j;p.cellIsAllDay=function(){return!0};p.allDayRow=function(a){return G.eq(a)};p.allDayBounds=function(){return{left:0,right:R}};p.getRowCnt=function(){return S};p.getColCnt=function(){return L};p.getColWidth=function(){return ba};p.getBodyRows=function(){return G};p.getDaySegmentContainer=function(){return t};Oa.call(p,b,d,c);Pa.call(p);Qa.call(p);ub.call(p);var n=
p.opt,k=p.trigger,x=p.clearEvents,v=p.renderOverlay,C=p.clearOverlays,F=d.formatDate,q,w,u,G,T,A,t,R,Z,ba,S,L,J,y,K,V,I,M,U,N,E;Fa(b.addClass("fc-grid"));J=new Ra(function(b,d){var c,e,f;u.each(function(b,g){c=a(g);e=c.offset().left;b&&(f[1]=e);f=[e];d[b]=f});f[1]=e+c.outerWidth();G.each(function(d,g){if(d<S)c=a(g),e=c.offset().top,d&&(f[1]=e),f=[e],b[d]=f});f[1]=e+c.outerHeight()});y=new Sa(J);K=new Ta(function(a){return bodyCellTopInners.eq(a)})}function ub(){function b(d){var e=o(c.visStart),f=
o(c.visEnd),g,h,i=[];g=a.map(d,O);h=[];var l,m=d.length,r,j,B,n,p;for(l=0;l<m;l++)r=d[l],j=r.start,B=g[l],B>e&&j<f&&(j<e?(j=o(e),n=!1):n=!0,B>f?(B=o(f),p=!1):p=!0,h.push({event:r,start:j,end:B,isStart:n,isEnd:p,msLength:B-j}));e=h.sort(X);d=[];g=e.length;for(f=0;f<g;f++){h=e[f];for(l=0;;){m=!1;if(d[l])for(r=0;r<d[l].length;r++)if(d[l][r].end>h.start&&d[l][r].start<h.end){m=!0;break}if(m)l++;else break}d[l]?d[l].push(h):d[l]=[h]}for(e=0;e<d.length;e++){f=d[e];for(g=0;g<f.length;g++)h=f[g],h.row=void 0,
h.level=e,i.push(h)}return i}function d(a,b){var c=x(),g;b.draggable({zIndex:9,delay:50,opacity:e("dragOpacity"),revertDuration:e("dragRevertDuration"),start:function(d,i){f("eventDragStart",b,a,d,i);n(a,b);c.start(function(d,c,f,i){b.draggable("option","revert",!d||!f&&!i);C();d?(g=7*f+i*(e("isRTL")?-1:1),v(h(o(a.start),g),h(O(a),g))):g=0},d,"drag")},stop:function(d,e){c.stop();C();f("eventDragStop",b,a,d,e);g?k(this,a,g,0,a.allDay,d,e):(b.css("filter",""),j(a,b))}})}var c=this;c.renderEvents=function(d){l(d);
d=b(d);try{var c=q();a("div.fc-day-content",c).html("");c.filter("td.fc-year-have-event").removeClass("fc-year-have-event ui-state-default");for(var e,f=0;f<d.length;f++)for(var g=o(d[f].start);g.getTime()<d[f].end.getTime();){e=c.filter(".fc-day-"+F(d[f].start,"yyyy-MM-dd"));e.addClass("fc-year-have-event ui-state-default");var i=a("div.fc-day-content",e).html();""!=a.trim(i)?a("div.fc-day-content",e).html(parseInt(i)+1):a("div.fc-day-content",e).html("1");h(g,1)}}catch(z){alert("MyrenderDaySegs:"+
z)}};c.compileDaySegs=b;c.clearEvents=function(){m();s().empty()};c.bindDaySeg=function(a,b,c){g(a)&&d(a,b);c.isEnd&&i(a)&&w(a,b,c);r(a,b)};Ua.call(c);var e=c.opt,f=c.trigger,g=c.isEventDraggable,i=c.isEventResizable,l=c.reportEvents,m=c.reportEventClear,r=c.eventElementHandlers,j=c.showEvents,n=c.hideEvents,k=c.eventDrop,s=c.getDaySegmentContainer,x=c.getHoverListener,v=c.renderDayOverlay,C=c.clearOverlays,q=c.getBodyRows,w=c.resizableDayEvent}function Va(b,d,c){function e(b){var d=b||1==y,c=k.start.getMonth(),
f=m(new Date),g,h,i;d&&G.each(function(b,d){g=a(d);h=j(b);g.html(w(h,$));Na(g,h)});t.each(function(b,e){g=a(e);h=j(b);h.getMonth()==c?g.removeClass("fc-other-month"):g.addClass("fc-other-month");+h==+f?g.addClass(H+"-state-highlight fc-today"):g.removeClass(H+"-state-highlight fc-today");g.find("div.fc-day-number").text(h.getDate());d&&Na(g,h)});A.each(function(b,d){i=a(d);b<y?(i.show(),b==y-1?i.addClass("fc-last"):i.removeClass("fc-last")):i.hide()})}function f(a){if(!x("selectable")){var b=parseInt(this.className.match(/fc\-day(\d+)/)[1]),
b=j(b);v("dayClick",this,b,!0,a)}}function g(a,b,d){d&&V.build();for(var d=o(k.visStart),c=h(o(d),K),e=0;e<y;e++){var l=new Date(Math.max(d,a)),z=new Date(Math.min(c,b));if(l<z){var m;U?(m=s(z,d)*N+E+1,l=s(l,d)*N+E+1):(m=s(l,d),l=s(z,d));i(e,m,e,l-1).click(f).mousedown(q)}h(d,7);h(c,7)}}function i(a,d,c,e){a=V.rect(a,d,c,e,b);return F(a,b)}function l(a){return{row:Math.floor(s(a,k.visStart)/7),col:n(a.getDay())}}function r(a){return h(o(k.visStart),7*a.row+a.col*N+E)}function j(a){return h(o(k.visStart),
7*Math.floor(a/K)+a%K*N+E)}function n(a){return(a-Math.max(P,ia)+K)%K*N+E}var k=this;k.renderBasic=function(d,c,g,h){y=c;K=g;(U=x("isRTL"))?(N=-1,E=K-1):(N=1,E=0);P=x("firstDay");ia=x("weekends")?0:1;H=x("theme")?"ui":"fc";$=x("columnFormat");if(c=!T){var i=H+"-widget-header",l=H+"-widget-content",o,g="<table class='fc-border-separate' style='width:100%' cellspacing='0'><thead><tr>";for(o=0;o<K;o++)g+="<th class='fc- "+i+"'/>";g+="</tr></thead><tbody>";for(o=0;o<d;o++){g+="<tr class='fc-week"+o+"'>";
for(i=0;i<K;i++)g+="<td class='fc- "+l+" fc-day"+(o*K+i)+"'><div>"+(h?"<div class='fc-day-number'/>":"")+"<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>";g+="</tr>"}d=a(g+"</tbody></table>").appendTo(b);u=d.find("thead");G=u.find("th");T=d.find("tbody");A=T.find("tr");t=T.find("td");R=t.filter(":first-child");Z=A.eq(0).find("div.fc-day-content div");Ga(u.add(u.find("tr")));Ga(A);A.eq(0).addClass("fc-first");t.click(f).mousedown(q);ba=a("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(b)}else C();
e(c)};k.setHeight=function(b){L=b;var b=L-u.height(),d,c,e;"variable"==x("weekMode")?d=c=Math.floor(b/(1==y?2:6)):(d=Math.floor(b/y),c=b-d*(y-1));R.each(function(b,f){b<y&&(e=a(f),Ca(e.find("> div"),(b==y-1?c:d)-va(e)))})};k.setWidth=function(a){S=a;M.clear();J=Math.floor(S/K);za(G.slice(0,-1),J)};k.renderDayOverlay=g;k.defaultSelectionEnd=function(a){return o(a)};k.renderSelection=function(a,b){g(a,h(o(b),1),!0)};k.clearSelection=function(){ja()};k.reportDayClick=function(a,b,d){var c=l(a);v("dayClick",
t[c.row*K+c.col],a,b,d)};k.dragStart=function(a,b){I.start(function(a){ja();a&&i(a.row,a.col,a.row,a.col)},b)};k.dragStop=function(a,b,d){var c=I.stop();ja();c&&(c=r(c),v("drop",a,c,!0,b,d))};k.defaultEventEnd=function(a){return o(a.start)};k.getHoverListener=function(){return I};k.colContentLeft=function(a){return M.left(a)};k.colContentRight=function(a){return M.right(a)};k.dayOfWeekCol=n;k.dateCell=l;k.cellDate=r;k.cellIsAllDay=function(){return!0};k.allDayRow=function(a){return A.eq(a)};k.allDayBounds=
function(){return{left:0,right:S}};k.getRowCnt=function(){return y};k.getColCnt=function(){return K};k.getColWidth=function(){return J};k.getDaySegmentContainer=function(){return ba};Oa.call(k,b,d,c);Pa.call(k);Qa.call(k);vb.call(k);var x=k.opt,v=k.trigger,C=k.clearEvents,F=k.renderOverlay,ja=k.clearOverlays,q=k.daySelectionMousedown,w=d.formatDate,u,G,T,A,t,R,Z,ba,S,L,J,y,K,V,I,M,U,N,E,P,ia,H,$;Fa(b.addClass("fc-grid"));V=new Ra(function(b,d){var c,e,f;G.each(function(b,g){c=a(g);e=c.offset().left;
b&&(f[1]=e);f=[e];d[b]=f});f[1]=e+c.outerWidth();A.each(function(d,g){if(d<y)c=a(g),e=c.offset().top,d&&(f[1]=e),f=[e],b[d]=f});f[1]=e+c.outerHeight()});I=new Sa(V);M=new Ta(function(a){return Z.eq(a)})}function vb(){function b(d){var e=q(),f=w(),g=o(c.visStart),f=h(o(g),f),i=a.map(d,O),l,m,k,r,j,n,B=[];for(l=0;l<e;l++){m=Y(xa(d,i,g,f));for(k=0;k<m.length;k++){r=m[k];for(j=0;j<r.length;j++)n=r[j],n.row=l,n.level=k,B.push(n)}h(g,7);h(f,7)}return B}function d(a,b){var c=x(),g;b.draggable({zIndex:9,
delay:50,opacity:e("dragOpacity"),revertDuration:e("dragRevertDuration"),start:function(d,i){f("eventDragStart",b,a,d,i);j(a,b);c.start(function(d,c,f,i){b.draggable("option","revert",!d||!f&&!i);C();d?(g=7*f+i*(e("isRTL")?-1:1),v(h(o(a.start),g),h(O(a),g))):g=0},d,"drag")},stop:function(d,e){c.stop();C();f("eventDragStop",b,a,d,e);g?n(this,a,g,0,a.allDay,d,e):(b.css("filter",""),r(a,b))}})}var c=this;c.renderEvents=function(a,d){l(a);u(b(a),d)};c.compileDaySegs=b;c.clearEvents=function(){m();s().empty()};
c.bindDaySeg=function(a,b,c){g(a)&&d(a,b);c.isEnd&&i(a)&&G(a,b,c);k(a,b)};Ua.call(c);var e=c.opt,f=c.trigger,g=c.isEventDraggable,i=c.isEventResizable,l=c.reportEvents,m=c.reportEventClear,k=c.eventElementHandlers,r=c.showEvents,j=c.hideEvents,n=c.eventDrop,s=c.getDaySegmentContainer,x=c.getHoverListener,v=c.renderDayOverlay,C=c.clearOverlays,q=c.getRowCnt,w=c.getColCnt,u=c.renderDaySegs,G=c.resizableDayEvent}function jb(b,d,e){function f(){function a(){H.scrollTop(c)}var b=r(),d=o(b);d.setHours(w("firstHour"));
var c=ka(b,d)+1;a();setTimeout(a,0)}function g(a){if(!w("selectable")){var b=Math.min(aa-1,Math.floor((a.pageX-L.offset().left-ma)/Ha)),d=x(b),c=this.parentNode.className.match(/fc-slot(\d+)/);c?(c=parseInt(c[1])*w("slotMinutes"),d.setHours(Math.floor(c/60)),d.setMinutes(c%60+na),u("dayClick",V[b],d,!1,a)):u("dayClick",V[b],d,!0,a)}}function i(a,b,d){d&&oa.build();var c=o(q.visStart);da?(d=s(b,c)*X+Y+1,a=s(a,c)*X+Y+1):(d=s(a,c),a=s(b,c));d=Math.max(0,d);a=Math.min(aa,a);d<a&&k(0,d,0,a-1).click(g).mousedown(Z)}
function k(a,b,d,c){a=oa.rect(a,b,d,c,N);return T(a,N)}function j(a,b){for(var d=o(q.visStart),c=h(o(d),1),e=0;e<aa;e++){var f=new Date(Math.max(d,a)),i=new Date(Math.min(c,b));if(f<i){var l=e*X+Y,l=oa.rect(0,l,0,l,$),f=ka(d,f),i=ka(d,i);l.top=f;l.height=i-f;T(l,$).click(g).mousedown(O)}h(d,1);h(c,1)}}function n(a){var b=x(a.col),a=a.row;w("allDaySlot")&&a--;0<=a&&l(b,na+a*w("slotMinutes"));return b}function x(a){return h(o(q.visStart),a*X+Y)}function p(a){return w("allDaySlot")&&!a.row}function v(a){return(a-
Math.max(ya,fa)+aa)%aa*X+Y}function ka(a,b){a=o(a,!0);if(b<l(o(a),na))return 0;if(b>=l(o(a),ca))return la.height();var d=w("slotMinutes"),e=60*b.getHours()+b.getMinutes()-na,f=Math.floor(e/d),g=W[f];if(g===c)g=W[f]=la.find("tr:eq("+f+") td div")[0].offsetTop;return Math.max(0,Math.round(g-1+Aa*(e%d/d)))}function F(b,d){var c=w("selectHelper");oa.build();if(c){var e=s(b,q.visStart)*X+Y;if(0<=e&&e<aa){var e=oa.rect(0,e,0,e,$),f=ka(b,b),h=ka(b,d);if(h>f){e.top=f;e.height=h-f;e.left+=2;e.width-=5;if(a.isFunction(c)){if(c=
c(b,d))e.position="absolute",e.zIndex=8,ga=a(c).css(e).appendTo($)}else e.isStart=!0,e.isEnd=!0,ga=a(ba({title:"",start:b,end:d,className:["fc-select-helper"],editable:!1},e)),ga.css("opacity",w("dragOpacity"));ga&&(ga.click(g).mousedown(O),$.append(ga),za(ga,e.width,!0),ab(ga,e.height,!0))}}}else j(b,d)}function Za(){A();ga&&(ga.remove(),ga=null)}function O(b){if(1==b.which&&w("selectable")){R(b);var d;ta.start(function(a,b){Za();if(a&&a.col==b.col&&!p(a)){var c=n(b),e=n(a);d=[c,l(o(c),w("slotMinutes")),
e,l(o(e),w("slotMinutes"))].sort(cb);F(d[0],d[3])}else d=null},b);a(document).one("mouseup",function(a){ta.stop();d&&(+d[0]==+d[1]&&ja(d[0],!1,a),t(d[0],d[3],!1,a))})}}function ja(a,b,d){u("dayClick",V[v(a.getDay())],a,b,d)}var q=this;q.renderAgenda=function(d){aa=d;Ba=w("theme")?"ui":"fc";fa=w("weekends")?0:1;ya=w("firstDay");(da=w("isRTL"))?(X=-1,Y=aa-1):(X=1,Y=0);na=C(w("minTime"));ca=C(w("maxTime"));ha=w("columnFormat");if(L)G();else{var d=Ba+"-widget-header",c=Ba+"-widget-content",e,f,h,i,k,
j=0==w("slotMinutes")%15;e="<table style='width:100%' class='fc-agenda-days fc-border-separate' cellspacing='0'><thead><tr><th class='fc-agenda-axis "+d+"'>&nbsp;</th>";for(f=0;f<aa;f++)e+="<th class='fc- fc-col"+f+" "+d+"'/>";e+="<th class='fc-agenda-gutter "+d+"'>&nbsp;</th></tr></thead><tbody><tr><th class='fc-agenda-axis "+d+"'>&nbsp;</th>";for(f=0;f<aa;f++)e+="<td class='fc- fc-col"+f+" "+c+"'><div><div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>";L=a(e+
("<td class='fc-agenda-gutter "+c+"'>&nbsp;</td></tr></tbody></table>")).appendTo(b);J=L.find("thead");y=J.find("th").slice(1,-1);K=L.find("tbody");V=K.find("td").slice(0,-1);I=V.find("div.fc-day-content div");M=V.eq(0);U=M.find("> div");Ga(J.add(J.find("tr")));Ga(K.add(K.find("tr")));ra=J.find("th:first");sa=L.find(".fc-agenda-gutter");N=a("<div style='position:absolute;z-index:2;left:0;width:100%'/>").appendTo(b);w("allDaySlot")?(E=a("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(N),
e="<table style='width:100%' class='fc-agenda-allday' cellspacing='0'><tr><th class='"+d+" fc-agenda-axis'>"+w("allDayText")+"</th><td><div class='fc-day-content'><div style='position:relative'/></div></td><th class='"+d+" fc-agenda-gutter'>&nbsp;</th></tr></table>",P=a(e).appendTo(N),ia=P.find("tr"),ia.find("td").click(g).mousedown(Z),ra=ra.add(P.find("th:first")),sa=sa.add(P.find("th.fc-agenda-gutter")),N.append("<div class='fc-agenda-divider "+d+"'><div class='fc-agenda-divider-inner'/></div>")):
E=a([]);H=a("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>").appendTo(N);$=a("<div style='position:relative;width:100%;overflow:hidden'/>").appendTo(H);fb=a("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo($);e="<table class='fc-agenda-slots' style='width:100%' cellspacing='0'><tbody>";h=r();i=l(o(h),ca);l(h,na);for(f=Wa=0;h<i;f++)k=h.getMinutes(),e+="<tr class='fc-slot"+f+" "+(!k?"":"fc-minor")+"'><th class='fc-agenda-axis "+d+"'>"+(!j||!k?S(h,w("axisFormat")):
"&nbsp;")+"</th><td class='"+c+"'><div style='position:relative'>&nbsp;</div></td></tr>",l(h,w("slotMinutes")),Wa++;la=a(e+"</tbody></table>").appendTo($);gb=la.find("div:first");la.find("td").click(g).mousedown(O);ra=ra.add(la.find("th:first"))}h=m(new Date);for(d=0;d<aa;d++)f=x(d),c=y.eq(d),c.html(S(f,ha)),e=V.eq(d),+f==+h?e.addClass(Ba+"-state-highlight fc-today"):e.removeClass(Ba+"-state-highlight fc-today"),Na(c.add(e),f)};q.setWidth=function(b){hb=b;Ia.clear();ma=0;za(ra.width("").each(function(b,
d){ma=Math.max(ma,a(d).outerWidth())}),ma);b=H[0].clientWidth;(Xa=H.width()-b)?(za(sa,Xa),sa.show().prev().removeClass("fc-last")):sa.hide().prev().addClass("fc-last");Ha=Math.floor((b-ma)/aa);za(y.slice(0,-1),Ha)};q.setHeight=function(a,b){a===c&&(a=ib);ib=a;W={};var d=K.position().top,e=H.position().top,g=Math.min(a-d,la.height()+e+1);U.height(g-va(M));N.css("top",d);H.height(g-e-1);Aa=gb.height()+1;b&&f()};q.beforeHide=function(){kb=H.scrollTop()};q.afterShow=function(){H.scrollTop(kb)};q.defaultEventEnd=
function(a){var b=o(a.start);return a.allDay?b:l(b,w("defaultEventMinutes"))};q.timePosition=ka;q.dayOfWeekCol=v;q.dateCell=function(a){return{row:Math.floor(s(a,q.visStart)/7),col:v(a.getDay())}};q.cellDate=n;q.cellIsAllDay=p;q.allDayRow=function(){return ia};q.allDayBounds=function(){return{left:ma,right:hb-Xa}};q.getHoverListener=function(){return ta};q.colContentLeft=function(a){return Ia.left(a)};q.colContentRight=function(a){return Ia.right(a)};q.getDaySegmentContainer=function(){return E};
q.getSlotSegmentContainer=function(){return fb};q.getMinMinute=function(){return na};q.getMaxMinute=function(){return ca};q.getBodyContent=function(){return $};q.getRowCnt=function(){return 1};q.getColCnt=function(){return aa};q.getColWidth=function(){return Ha};q.getSlotHeight=function(){return Aa};q.defaultSelectionEnd=function(a,b){return b?o(a):l(o(a),w("slotMinutes"))};q.renderDayOverlay=i;q.renderSelection=function(a,b,d){d?w("allDaySlot")&&i(a,h(o(b),1),!0):F(a,b)};q.clearSelection=Za;q.reportDayClick=
ja;q.dragStart=function(a,b){ta.start(function(a){A();if(a)if(p(a))k(a.row,a.col,a.row,a.col);else{var a=n(a),b=l(o(a),w("defaultEventMinutes"));j(a,b)}},b)};q.dragStop=function(a,b,d){var c=ta.stop();A();c&&u("drop",a,n(c),p(c),b,d)};Oa.call(q,b,d,e);Pa.call(q);Qa.call(q);wb.call(q);var w=q.opt,u=q.trigger,G=q.clearEvents,T=q.renderOverlay,A=q.clearOverlays,t=q.reportSelection,R=q.unselect,Z=q.daySelectionMousedown,ba=q.slotSegHtml,S=d.formatDate,L,J,y,K,V,I,M,U,N,E,P,ia,H,$,fb,la,gb,ra,sa,ga,hb,
ib,ma,Ha,Xa,Aa,kb,aa,Wa,oa,ta,Ia,W={},Ba,ya,fa,da,X,Y,na,ca,ha;Fa(b.addClass("fc-agenda"));oa=new Ra(function(b,d){var c,e,f;y.each(function(b,g){c=a(g);e=c.offset().left;b&&(f[1]=e);f=[e];d[b]=f});f[1]=e+c.outerWidth();if(w("allDaySlot"))c=ia,e=c.offset().top,b[0]=[e,e+c.outerHeight()];for(var g=$.offset().top,h=H.offset().top,i=h+H.outerHeight(),l=0;l<Wa;l++)b.push([Math.max(h,Math.min(i,g+Aa*l)),Math.max(h,Math.min(i,g+Aa*(l+1)))])});ta=new Sa(oa);Ia=new Ta(function(a){return I.eq(a)})}function wb(){function b(d){var d=
Y(xa(d,a.map(d,O),k.visStart,k.visEnd)),c,e=d.length,f,g,h,i=[];for(c=0;c<e;c++){f=d[c];for(g=0;g<f.length;g++)h=f[g],h.row=0,h.level=c,i.push(h)}return i}function d(a){return a.end?o(a.end):l(o(a.start),j("defaultEventMinutes"))}function e(a,b){var d="<",c=a.url,f=eb(a,j),g=f?" style='"+f+"'":"",h=["fc-event","fc-event-skin","fc-event-vert"];n(a)&&h.push("fc-event-draggable");b.isStart&&h.push("fc-corner-top");b.isEnd&&h.push("fc-corner-bottom");h=h.concat(a.className);a.source&&(h=h.concat(a.source.className||
[]));d=c?d+("a href='"+qa(a.url)+"'"):d+"div";d+=" class='"+h.join(" ")+"' style='position:absolute;z-index:8;top:"+b.top+"px;left:"+b.left+"px;"+f+"'><div class='fc-event-inner fc-event-skin'"+g+"><div class='fc-event-head fc-event-skin'"+g+"><div class='fc-event-time'>"+qa(H(a.start,a.end,j("timeFormat")))+"</div></div><div class='fc-event-content'><div class='fc-event-title'>"+qa(a.title)+"</div></div><div class='fc-event-bg'></div></div>";b.isEnd&&s(a)&&(d+="<div class='ui-resizable-handle ui-resizable-s'>=</div>");
return d+("</"+(c?"a":"div")+">")}function f(a,b,d){var c=b.find("div.fc-event-time");n(a)&&i(a,b,c);d.isEnd&&s(a)&&m(a,b,c);F(a,b)}function g(a,b,d){function c(){i||(b.width(e).height("").draggable("option","grid",null),i=!0)}var e,f,i=!0,l,k=j("isRTL")?-1:1,m=u(),n=L(),z=J(),B=T();b.draggable({zIndex:9,opacity:j("dragOpacity","month"),revertDuration:j("dragRevertDuration"),start:function(g,B){r("eventDragStart",b,a,g,B);I(a,b);e=b.width();m.start(function(e,g,m,r){E();e?(f=!1,l=r*k,e.row?d?i&&(b.width(n-
10),ab(b,z*Math.round((a.end?(a.end-a.start)/xb:j("defaultEventMinutes"))/j("slotMinutes"))),b.draggable("option","grid",[n,1]),i=!1):f=!0:(N(h(o(a.start),l),h(O(a),l)),c()),f=f||i&&!l):(c(),f=!0);b.draggable("option","revert",f)},g,"drag")},stop:function(d,e){m.stop();E();r("eventDragStop",b,a,d,e);if(f)c(),b.css("filter",""),V(a,b);else{var g=0;i||(g=Math.round((b.offset().top-y().offset().top)/z)*j("slotMinutes")+B-(60*a.start.getHours()+a.start.getMinutes()));M(this,a,l,g,i,d,e)}}})}function i(a,
b,d){function c(b){var e=l(o(a.start),b),f;a.end&&(f=l(o(a.end),b));d.text(H(e,f,j("timeFormat")))}function e(){g&&(d.css("display",""),b.draggable("option","grid",[w,s]),g=!1)}var f,g=!1,k,m,n,z=j("isRTL")?-1:1,B=u(),p=S(),w=L(),s=J();b.draggable({zIndex:9,scroll:!1,grid:[w,s],axis:1==p?"y":!1,opacity:j("dragOpacity"),revertDuration:j("dragRevertDuration"),start:function(c,i){r("eventDragStart",b,a,c,i);I(a,b);f=b.position();m=n=0;B.start(function(c,f,i,l){b.draggable("option","revert",!c);E();c&&
(k=l*z,j("allDaySlot")&&!c.row?(g||(g=!0,d.hide(),b.draggable("option","grid",null)),N(h(o(a.start),k),h(O(a),k))):e())},c,"drag")},drag:function(a,b){m=Math.round((b.position.top-f.top)/s)*j("slotMinutes");m!=n&&(g||c(m),n=m)},stop:function(d,h){var i=B.stop();E();r("eventDragStop",b,a,d,h);i&&(k||m||g)?M(this,a,k,g?0:m,g,d,h):(e(),b.css("filter",""),b.css(f),c(0),V(a,b))}})}function m(a,b,d){var c,e,f=J();b.resizable({handles:{s:"div.ui-resizable-s"},grid:f,start:function(d,f){c=e=0;I(a,b);b.css("z-index",
9);r("eventResizeStart",this,a,d,f)},resize:function(g,h){c=Math.round((Math.max(f,b.height())-h.originalSize.height)/f);c!=e&&(d.text(H(a.start,!c&&!a.end?null:l(x(a),j("slotMinutes")*c),j("timeFormat"))),e=c)},stop:function(d,e){r("eventResizeStop",this,a,d,e);c?U(this,a,0,j("slotMinutes")*c,d,e):(b.css("z-index",8),V(a,b))}})}var k=this;k.renderEvents=function(g,i){v(g);var m,n=g.length,p=[],s=[];for(m=0;m<n;m++)g[m].allDay?p.push(g[m]):s.push(g[m]);j("allDaySlot")&&(Z(b(p),i),ja());var n=S(),
p=T(),x=G(),u=l(o(k.visStart),p),q=a.map(s,d),E,D,I,Q,H,M;m=[];for(E=0;E<n;E++){I=D=Y(xa(s,q,u,l(o(u),x-p)));var N=M=H=Q=void 0,P=void 0,U=void 0;for(Q=I.length-1;0<Q;Q--){N=I[Q];for(H=0;H<N.length;H++){P=N[H];for(M=0;M<I[Q-1].length;M++)if(U=I[Q-1][M],P.end>U.start&&P.start<U.end)U.forward=Math.max(U.forward||0,(P.forward||0)+1)}}for(I=0;I<D.length;I++){Q=D[I];for(H=0;H<Q.length;H++)M=Q[H],M.col=E,M.level=I,m.push(M)}h(u,1,!0)}var s=m.length,pa,C,y;D="";x={};u={};E=w();n=S();(I=j("isRTL"))?(Q=-1,
N=n-1):(Q=1,N=0);for(n=0;n<s;n++)p=m[n],q=p.event,H=A(p.start,p.start),M=A(p.start,p.end),pa=p.col,P=p.level,U=p.forward||0,C=t(pa*Q+N),y=R(pa*Q+N)-C,y=Math.min(y-6,0.95*y),pa=P?y/(P+U+1):U?2*(y/(U+1)-6):y,P=C+y/(P+U+1)*P*Q+(I?y-pa:0),p.top=H,p.left=P,p.outerWidth=pa,p.outerHeight=M-H,D+=e(q,p);E[0].innerHTML=D;I=E.children();for(n=0;n<s;n++)p=m[n],q=p.event,D=a(I[n]),Q=r("eventRender",q,q,D),!1===Q?D.remove():(Q&&!0!==Q&&(D.remove(),D=a(Q).css({position:"absolute",top:p.top,left:p.left}).appendTo(E)),
p.element=D,q._id===i?f(q,D,p):D[0]._fci=n,K(q,D));ya(E,m,f);for(n=0;n<s;n++)if(p=m[n],D=p.element)if(E=x[q=p.key=db(D[0])],p.vsides=E===c?x[q]=va(D,!0):E,E=u[q],p.hsides=E===c?u[q]=Ka(D)+La(D)+Ma(D):E,q=D.find("div.fc-event-content"),q.length)p.contentTop=q[0].offsetTop;for(n=0;n<s;n++)if(p=m[n],D=p.element)D[0].style.width=Math.max(0,p.outerWidth-p.hsides)+"px",x=Math.max(0,p.outerHeight-p.vsides),D[0].style.height=x+"px",q=p.event,p.contentTop!==c&&10>x-p.contentTop&&(D.find("div.fc-event-time").text(ia(q.start,
j("timeFormat"))+" - "+q.title),D.find("div.fc-event-title").remove()),r("eventAfterRender",q,q,D)};k.compileDaySegs=b;k.clearEvents=function(){C();q().empty();w().empty()};k.slotSegHtml=e;k.bindDaySeg=function(a,b,d){n(a)&&g(a,b,d.isStart);d.isEnd&&s(a)&&ba(a,b,d);F(a,b)};Ua.call(k);var j=k.opt,r=k.trigger,n=k.isEventDraggable,s=k.isEventResizable,x=k.eventEnd,v=k.reportEvents,C=k.reportEventClear,F=k.eventElementHandlers,ja=k.setHeight,q=k.getDaySegmentContainer,w=k.getSlotSegmentContainer,u=k.getHoverListener,
G=k.getMaxMinute,T=k.getMinMinute,A=k.timePosition,t=k.colContentLeft,R=k.colContentRight,Z=k.renderDaySegs,ba=k.resizableDayEvent,S=k.getColCnt,L=k.getColWidth,J=k.getSlotHeight,y=k.getBodyContent,K=k.reportEventElement,V=k.showEvents,I=k.hideEvents,M=k.eventDrop,U=k.eventResize,N=k.renderDayOverlay,E=k.clearOverlays,P=k.calendar,ia=P.formatDate,H=P.formatDates}function Oa(a,b,d){function e(a,b){var c=q[a];return"object"==typeof c?Ja(c,b||d):c}function f(a,d){return b.trigger.apply(b,[a,d||j].concat(Array.prototype.slice.call(arguments,
2),[j]))}function g(a){return wa(a.editable,(a.source||{}).editable,e("editable"))}function i(a){return a.end?o(a.end):r(a)}function k(a,b,d){var a=F[a._id],c,e=a.length;for(c=0;c<e;c++)if(!b||a[c][0]!=b[0])a[c][d]()}function m(a,b,d,e){for(var d=d||0,f,g=a.length,i=0;i<g;i++){f=a[i];if(e!==c)f.allDay=e;l(h(f.start,b,!0),d);if(f.end)f.end=l(h(f.end,b,!0),d);s(f,q)}}function n(a,b,d){for(var d=d||0,c,e=a.length,f=0;f<e;f++)c=a[f],c.end=l(h(i(c),b,!0),d),s(c,q)}var j=this;j.element=a;j.calendar=b;j.name=
d;j.opt=e;j.trigger=f;j.isEventDraggable=function(a){return g(a)&&!e("disableDragging")};j.isEventResizable=function(a){return g(a)&&!e("disableResizing")};j.reportEvents=function(a){v={};var b,d=a.length,c;for(b=0;b<d;b++)c=a[b],v[c._id]?v[c._id].push(c):v[c._id]=[c]};j.eventEnd=i;j.reportEventElement=function(a,b){C.push(b);F[a._id]?F[a._id].push(b):F[a._id]=[b]};j.reportEventClear=function(){C=[];F={}};j.eventElementHandlers=function(a,b){b.click(function(d){if(!b.hasClass("ui-draggable-dragging")&&
!b.hasClass("ui-resizable-resizing"))return f("eventClick",this,a,d)}).hover(function(b){f("eventMouseover",this,a,b)},function(b){f("eventMouseout",this,a,b)})};j.showEvents=function(a,b){k(a,b,"show")};j.hideEvents=function(a,b){k(a,b,"hide")};j.eventDrop=function(a,b,d,c,e,g,h){var i=b.allDay,l=b._id;m(v[l],d,c,e);f("eventDrop",a,b,d,c,e,function(){m(v[l],-d,-c,i);x(l)},g,h);x(l)};j.eventResize=function(a,b,d,c,e,g){var h=b._id;n(v[h],d,c);f("eventResize",a,b,d,c,function(){n(v[h],-d,-c);x(h)},
e,g);x(h)};var r=j.defaultEventEnd,s=b.normalizeEvent,x=b.reportEventChange,v={},C=[],F={},q=b.options}function Ua(){function b(a){var d=m("isRTL"),c,e=a.length,f,g,h,i;c=O();var l=c.left,j=c.right,o,k,n,z,p,B="";for(c=0;c<e;c++)f=a[c],g=f.event,i=["fc-event","fc-event-skin","fc-event-hori"],r(g)&&i.push("fc-event-draggable"),d?(f.isStart&&i.push("fc-corner-right"),f.isEnd&&i.push("fc-corner-left"),o=R(f.end.getDay()-1),k=R(f.start.getDay()),n=f.isEnd?A(o):l,z=f.isStart?t(k):j):(f.isStart&&i.push("fc-corner-left"),
f.isEnd&&i.push("fc-corner-right"),o=R(f.start.getDay()),k=R(f.end.getDay()-1),n=f.isStart?A(o):l,z=f.isEnd?t(k):j),i=i.concat(g.className),g.source&&(i=i.concat(g.source.className||[])),h=g.url,p=eb(g,m),B=h?B+("<a href='"+qa(h)+"'"):B+"<div",B+=" class='"+i.join(" ")+"' style='position:absolute;z-index:8;left:"+n+"px;"+p+"'><div class='fc-event-inner fc-event-skin'"+(p?" style='"+p+"'":"")+">",!g.allDay&&f.isStart&&(B+="<span class='fc-event-time'>"+qa(J(g.start,g.end,m("timeFormat")))+"</span>"),
B+="<span class='fc-event-title'>"+qa(g.title)+"</span></div>",f.isEnd&&s(g)&&(B+="<div class='ui-resizable-handle ui-resizable-"+(d?"w":"e")+"'>&nbsp;&nbsp;&nbsp;</div>"),B+="</"+(h?"a":"div")+">",f.left=n,f.outerWidth=z-n,f.startCol=o,f.endCol=k+1;return B}function d(b,c){var e,f=b.length,g,h,i;for(e=0;e<f;e++)g=b[e],h=g.event,i=a(c[e]),h=n("eventRender",h,h,i),!1===h?i.remove():(h&&!0!==h&&(h=a(h).css({position:"absolute",left:g.left}),i.replaceWith(h),i=h),g.element=i)}function e(a){var b,d=a.length,
f,g,h,i,l={};for(b=0;b<d;b++)if(f=a[b],g=f.element)h=f.key=db(g[0]),i=l[h],i===c&&(i=l[h]=Ka(g)+La(g)+Ma(g)),f.hsides=i}function f(a){var b,d=a.length,c,e;for(b=0;b<d;b++)if(c=a[b],e=c.element)e[0].style.width=Math.max(0,c.outerWidth-c.hsides)+"px"}function g(a){var b,d=a.length,e,f,h,i,l={};for(b=0;b<d;b++)if(e=a[b],f=e.element)h=e.key,i=l[h],i===c&&(i=l[h]=bb(f)),e.outerHeight=f[0].offsetHeight+i}function i(){var a,b=w(),d=[];for(a=0;a<b;a++)d[a]=G(a).find("td:first div.fc-day-content > div");return d}
function l(a){var b,d=a.length,c=[];for(b=0;b<d;b++)c[b]=a[b][0].offsetTop;return c}function k(a,b){var d,c=a.length,e,f;for(d=0;d<c;d++)if(e=a[d],f=e.element)f[0].style.top=b[e.row]+(e.top||0)+"px",e=e.event,n("eventAfterRender",e,e,f)}var j=this;j.renderDaySegs=function(a,c){var h=S(),o=w(),j=u(),m=0,n,r,p,s=a.length,x,q;h[0].innerHTML=b(a);d(a,h.children());r=a.length;for(n=0;n<r;n++)p=a[n],(q=p.element)&&v(p.event,q);r=a.length;var t;for(n=0;n<r;n++)if(p=a[n],q=p.element)t=p.event,t._id===c?L(t,
q,p):q[0]._fci=n;ya(h,a,L);e(a);f(a);g(a);h=i();for(n=0;n<o;n++){r=[];for(p=0;p<j;p++)r[p]=0;for(;m<s&&(x=a[m]).row==n;){p=r.slice(x.startCol,x.endCol);p=Math.max.apply(Math,p);x.top=p;p+=x.outerHeight;for(q=x.startCol;q<x.endCol;q++)r[q]=p;m++}h[n].height(Math.max.apply(Math,r))}k(a,l(h))};j.resizableDayEvent=function(c,r,s){var v=m("isRTL"),t=v?"w":"e",A=r.find("div.ui-resizable-"+t),G=!1;Fa(r);r.mousedown(function(a){a.preventDefault()}).click(function(a){G&&(a.preventDefault(),a.stopImmediatePropagation())});
A.mousedown(function(m){if(1==m.which){G=!0;var A=j.getHoverListener(),nb=w(),J=u(),L=v?-1:1,ua=v?J-1:0,ka=r.css("top"),O,P,T=a.extend({},c),R=W(c.start);V();a("body").css("cursor",t+"-resize").one("mouseup",function(b){n("eventResizeStop",this,c,b);a("body").css("cursor","");A.stop();K();O&&q(this,c,O,0,b);setTimeout(function(){G=!1},0)});n("eventResizeStart",this,c,m);A.start(function(j,n){if(j){var m=Math.max(R.row,j.row),r=j.col;1==nb&&(m=0);m==R.row&&(r=v?Math.min(R.col,r):Math.max(R.col,r));
O=7*m+r*L+ua-(7*n.row+n.col*L+ua);m=h(x(c),O,!0);if(O){T.end=m;var r=P,p=X([T]),q=s.row,u=a("<div/>"),w=S(),ea=p.length,A;u[0].innerHTML=b(p);u=u.children();w.append(u);d(p,u);e(p);f(p);g(p);k(p,l(i()));u=[];for(w=0;w<ea;w++)if(A=p[w].element)p[w].row===q&&A.css("top",ka),u.push(A[0]);P=a(u);P.find("*").css("cursor",t+"-resize");r&&r.remove();F(c)}else P&&(C(c),P.remove(),P=null);K();y(c.start,h(o(m),1))}},m)}})};var m=j.opt,n=j.trigger,r=j.isEventDraggable,s=j.isEventResizable,x=j.eventEnd,v=j.reportEventElement,
C=j.showEvents,F=j.hideEvents,q=j.eventResize,w=j.getRowCnt,u=j.getColCnt,G=j.allDayRow,O=j.allDayBounds,A=j.colContentLeft,t=j.colContentRight,R=j.dayOfWeekCol,W=j.dateCell,X=j.compileDaySegs,S=j.getDaySegmentContainer,L=j.bindDaySeg,J=j.calendar.formatDates,y=j.renderDayOverlay,K=j.clearOverlays,V=j.clearSelection}function Qa(){function b(a){l&&(l=!1,i(),f("unselect",null,a))}function d(a,b,c,e){l=!0;f("select",null,a,b,c,e)}var c=this;c.select=function(a,c,e){b();c||(c=g(a,e));h(a,c,e);d(a,c,e)};
c.unselect=b;c.reportSelection=d;c.daySelectionMousedown=function(f){var g=c.cellDate,l=c.cellIsAllDay,j=c.getHoverListener(),o=c.reportDayClick;if(1==f.which&&e("selectable")){b(f);var k;j.start(function(a,b){i();a&&l(a)?(k=[g(b),g(a)].sort(cb),h(k[0],k[1],!0)):k=null},f);a(document).one("mouseup",function(a){j.stop();k&&(+k[0]==+k[1]&&o(k[0],!0,a),d(k[0],k[1],!0,a))})}};var e=c.opt,f=c.trigger,g=c.defaultSelectionEnd,h=c.renderSelection,i=c.clearSelection,l=!1;e("selectable")&&e("unselectAuto")&&
a(document).mousedown(function(d){var c=e("unselectCancel");(!c||!a(d.target).parents(c).length)&&b(d)})}function Pa(){this.renderOverlay=function(c,e){var f=d.shift();f||(f=a("<div class='fc-cell-overlay' style='position:absolute;z-index:3'/>"));f[0].parentNode!=e[0]&&f.appendTo(e);b.push(f.css(c).show());return f};this.clearOverlays=function(){for(var a;a=b.shift();)d.push(a.hide().unbind())};var b=[],d=[]}function Ra(a){var b,d;this.build=function(){b=[];d=[];a(b,d)};this.cell=function(a,c){var e=
b.length,f=d.length,g,h=-1,i=-1;for(g=0;g<e;g++)if(c>=b[g][0]&&c<b[g][1]){h=g;break}for(g=0;g<f;g++)if(a>=d[g][0]&&a<d[g][1]){i=g;break}return 0<=h&&0<=i?{row:h,col:i}:null};this.rect=function(a,c,e,f,g){g=g.offset();return{top:b[a][0]-g.top,left:d[c][0]-g.left,width:d[f][1]-d[c][0],height:b[e][1]-b[a][0]}}}function Sa(b){function d(a){if(a.pageX===c)a.pageX=a.originalEvent.pageX,a.pageY=a.originalEvent.pageY;a=b.cell(a.pageX,a.pageY);if(!a!=!h||a&&(a.row!=h.row||a.col!=h.col))a?(g||(g=a),f(a,g,a.row-
g.row,a.col-g.col)):f(a,g),h=a}var e,f,g,h;this.start=function(c,i,l){f=c;g=h=null;b.build();d(i);e=l||"mousemove";a(document).bind(e,d)};this.stop=function(){a(document).unbind(e,d);return h}}function Ta(a){var b=this,d={},e={},f={};b.left=function(b){return e[b]=e[b]===c?(d[b]=d[b]||a(b)).position().left:e[b]};b.right=function(e){return f[e]=f[e]===c?b.left(e)+(d[e]=d[e]||a(e)).width():f[e]};b.clear=function(){d={};e={};f={}}}var ca={defaultView:"month",aspectRatio:1.35,header:{left:"title",center:"",
right:"today prev,next"},weekends:!0,allDayDefault:!0,ignoreTimezone:!0,lazyFetching:!0,startParam:"start",endParam:"end",titleFormat:{year:"yyyy",month:"MMMM yyyy",week:"MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}",day:"dddd, MMM d, yyyy"},columnFormat:{year:"MMMM",month:"ddd",week:"ddd M/d",day:"dddd M/d"},timeFormat:{"":"h(:mm)t"},isRTL:!1,firstDay:0,monthNames:"January,February,March,April,May,June,July,August,September,October,November,December".split(","),monthNamesShort:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),
...
center:"",right:"title"},buttonText:{prev:"&nbsp;&#9658;&nbsp;",next:"&nbsp;&#9668;&nbsp;",prevYear:"&nbsp;&gt;&gt;&nbsp;",nextYear:"&nbsp;&lt;&lt;&nbsp;"},buttonIcons:{prev:"circle-triangle-e",next:"circle-triangle-w"}},W=a.fullCalendar={version:"1.5.1"},da=W.views={};a.fn.fullCalendar=function(b){if("string"==typeof b){var e=Array.prototype.slice.call(arguments,1),f;this.each(function(){var d=a.data(this,"fullCalendar");d&&a.isFunction(d[b])&&(d=d[b].apply(d,e),f===c&&(f=d),"destroy"==b&&a.removeData(this,
"fullCalendar"))});return f!==c?f:this}var g=b.eventSources||[];delete b.eventSources;b.events&&(g.push(b.events),delete b.events);b=a.extend(!0,{},ca,b.isRTL||b.isRTL===c&&ca.isRTL?yb:{},b);this.each(function(c,e){var f=a(e),h=new d(f,b,g);f.data("fullCalendar",h);h.render()});return this};W.sourceNormalizers=[];W.sourceFetchers=[];var ob={dataType:"json",cache:!1},pb=1;W.addDays=h;W.cloneDate=o;W.parseDate=k;W.parseISO8601=v;W.parseTime=C;W.formatDate=F;W.formatDates=fa;var sb="sun,mon,tue,wed,thu,fri,sat".split(","),
$a=864E5,qb=36E5,xb=6E4,rb={s:function(a){return a.getSeconds()},ss:function(a){return ha(a.getSeconds())},m:function(a){return a.getMinutes()},mm:function(a){return ha(a.getMinutes())},h:function(a){return a.getHours()%12||12},hh:function(a){return ha(a.getHours()%12||12)},H:function(a){return a.getHours()},HH:function(a){return ha(a.getHours())},d:function(a){return a.getDate()},dd:function(a){return ha(a.getDate())},ddd:function(a,b){return b.dayNamesShort[a.getDay()]},e:function(a,b){return b.dayNamesShortest[a.getDay()]},
dddd:function(a,b){return b.dayNames[a.getDay()]},M:function(a){return a.getMonth()+1},MM:function(a){return ha(a.getMonth()+1)},MMM:function(a,b){return b.monthNamesShort[a.getMonth()]},MMMM:function(a,b){return b.monthNames[a.getMonth()]},yy:function(a){return(a.getFullYear()+"").substring(2)},yyyy:function(a){return a.getFullYear()},t:function(a){return 12>a.getHours()?"a":"p"},tt:function(a){return 12>a.getHours()?"am":"pm"},T:function(a){return 12>a.getHours()?"A":"P"},TT:function(a){return 12>
a.getHours()?"AM":"PM"},u:function(a){return F(a,"yyyy-MM-dd'T'HH:mm:ss'Z'")},S:function(a){a=a.getDate();return 10<a&&20>a?"th":["st","nd","rd"][a%10-1]||"th"}};W.applyAll=Ea;da.year=function(a,b){var d=this;d.render=function(a,b){if(b)d.curYear=g(a,b);var h=o(a,!0);h.setFullYear(h.getFullYear(),0,1);var i=o(a);i.setFullYear(i.getFullYear(),11,31);var l=o(h),j=o(i),k=c("weekends")?0:1;d.title=f(h,c("titleFormat"));d.start=h;d.end=i;d.visStart=l;d.visEnd=j;e("4x3",6,k?5:7,!0)};tb.call(d,a,b,"year");
var c=d.opt,e=d.renderYear,f=b.formatDate};da.month=function(a,b){var d=this;d.render=function(a,b){b&&(i(a,b),a.setDate(1));var g=o(a,!0);g.setDate(1);var l=i(o(g),1),j=o(g),k=o(l),m=c("firstDay"),r=c("weekends")?0:1;r&&(n(j),n(k,-1,!0));h(j,-((j.getDay()-Math.max(m,r)+7)%7));h(k,(7-k.getDay()+Math.max(m,r))%7);m=Math.round((k-j)/(7*$a));"fixed"==c("weekMode")&&(h(k,7*(6-m)),m=6);d.title=f(g,c("titleFormat"));d.start=g;d.end=l;d.visStart=j;d.visEnd=k;e(6,m,r?5:7,!0)};Va.call(d,a,b,"month");var c=
d.opt,e=d.renderBasic,f=b.formatDate};da.basicWeek=function(a,b){var d=this;d.render=function(a,b){b&&h(a,7*b);var g=h(o(a),-((a.getDay()-c("firstDay")+7)%7)),i=h(o(g),7),l=o(g),j=o(i),k=c("weekends");k||(n(l),n(j,-1,!0));d.title=f(l,h(o(j),-1),c("titleFormat"));d.start=g;d.end=i;d.visStart=l;d.visEnd=j;e(1,1,k?7:5,!1)};Va.call(d,a,b,"basicWeek");var c=d.opt,e=d.renderBasic,f=b.formatDates};da.basicDay=function(a,b){var d=this;d.render=function(a,b){b&&(h(a,b),c("weekends")||n(a,0>b?-1:1));d.title=
f(a,c("titleFormat"));d.start=d.visStart=o(a,!0);d.end=d.visEnd=h(o(d.start),1);e(1,1,1,!1)};Va.call(d,a,b,"basicDay");var c=d.opt,e=d.renderBasic,f=b.formatDate};b({weekMode:"fixed"});da.agendaWeek=function(a,b){var d=this;d.render=function(a,b){b&&h(a,7*b);var g=h(o(a),-((a.getDay()-c("firstDay")+7)%7)),i=h(o(g),7),l=o(g),j=o(i),k=c("weekends");k||(n(l),n(j,-1,!0));d.title=f(l,h(o(j),-1),c("titleFormat"));d.start=g;d.end=i;d.visStart=l;d.visEnd=j;e(k?7:5)};jb.call(d,a,b,"agendaWeek");var c=d.opt,
e=d.renderAgenda,f=b.formatDates};da.agendaDay=function(a,b){var d=this;d.render=function(a,b){b&&(h(a,b),c("weekends")||n(a,0>b?-1:1));var g=o(a,!0),i=h(o(g),1);d.title=f(a,c("titleFormat"));d.start=d.visStart=g;d.end=d.visEnd=i;e(1)};jb.call(d,a,b,"agendaDay");var c=d.opt,e=d.renderAgenda,f=b.formatDate};b({allDaySlot:!0,allDayText:"all-day",firstHour:6,slotMinutes:30,defaultEventMinutes:120,axisFormat:"h(:mm)tt",timeFormat:{agenda:"h:mm{ - h:mm}"},dragOpacity:{agenda:0.5},minTime:0,maxTime:24})})(jQuery);
